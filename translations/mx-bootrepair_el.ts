...
<context>
    ...
    <message>
        ...
        <translation>Η Επισκευή Boot του MX είναι ένα εργαλείο που μπορεί να χρησιμοποιηθεί για την επανεγκατάσταση του GRUB2 στο MBR (Master Boot Record) ή root PBR. Παρέχει τη δυνατότητα να ανακατασκευάσει το αρχείο ρυθμίσεων του GRUB2 και να δημιουργήσετε αντίγραφα ασφαλείας και να αποκαταστήσει MBR ή PBR.</translation>
    </message>
    <message>
...
Please double-check the selected location.</source>
    ...
    <message>
        ...
        <translation type="obsolete">Απλή Επισκευή Εκκίνησης</translation>
    </message>
    <message>
